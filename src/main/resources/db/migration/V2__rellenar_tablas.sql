...
-- Ingresos previos para asegurar saldos no negativos (5 ingresos por usuario, marzo 2026)
INSERT INTO `transaccion` (`cantidad`, `descripcion`, `fecha`, `tipo_transaccion`, `categoria_id`, `usuario_id`) VALUES
-- Usuario 1 (Juan)
(1000.00, 'Nómina', '2026-03-01 09:00:00', 1, 3, 1),
(300.00, 'Bizum recibido', '2026-03-05 12:00:00', 1, 3, 1),
(200.00, 'Ingreso extra', '2026-03-10 15:00:00', 1, 3, 1),
(300.00, 'Devolución', '2026-03-15 10:00:00', 1, 3, 1),
(200.00, 'Bizum', '2026-03-20 18:00:00', 1, 3, 1),
-- Usuario 2 (Irene)
(1000.00, 'Nómina', '2026-03-02 09:00:00', 1, 3, 2),
(300.00, 'Bizum recibido', '2026-03-06 12:30:00', 1, 3, 2),
(200.00, 'Ingreso extra', '2026-03-11 14:00:00', 1, 3, 2),
(300.00, 'Devolución', '2026-03-16 11:00:00', 1, 3, 2),
(200.00, 'Bizum', '2026-03-21 17:00:00', 1, 3, 2),
-- Usuario 3 (María)
(1000.00, 'Nómina', '2026-03-03 09:30:00', 1, 3, 3),
(300.00, 'Bizum recibido', '2026-03-07 12:10:00', 1, 3, 3),
(200.00, 'Ingreso extra', '2026-03-12 16:00:00', 1, 3, 3),
(300.00, 'Devolución', '2026-03-17 10:30:00', 1, 3, 3),
(200.00, 'Bizum', '2026-03-22 18:30:00', 1, 3, 3),
-- Usuario 4 (Pedro)
(1000.00, 'Nómina', '2026-03-04 08:50:00', 1, 3, 4),
(300.00, 'Bizum recibido', '2026-03-08 13:00:00', 1, 3, 4),
(200.00, 'Ingreso extra', '2026-03-13 15:30:00', 1, 3, 4),
(300.00, 'Devolución', '2026-03-18 09:45:00', 1, 3, 4),
(200.00, 'Bizum', '2026-03-23 19:00:00', 1, 3, 4),
-- Usuario 5 (Ana)
(1000.00, 'Nómina', '2026-03-05 09:10:00', 1, 3, 5),
(300.00, 'Bizum recibido', '2026-03-09 12:40:00', 1, 3, 5),
(200.00, 'Ingreso extra', '2026-03-14 14:20:00', 1, 3, 5),
(300.00, 'Devolución', '2026-03-19 11:15:00', 1, 3, 5),
(200.00, 'Bizum', '2026-03-24 18:20:00', 1, 3, 5);


INSERT INTO `transaccion` (`cantidad`, `descripcion`, `fecha`, `tipo_transaccion`, `categoria_id`, `usuario_id`) VALUES
-- Usuario 1 (Juan) - 20 gastos distribuidos en Apr/May/Jun 2026
(45.20, 'Compra supermercado', '2026-04-02 09:15:00', 0, 4, 1),
(12.50, 'Café y snacks', '2026-04-05 11:30:00', 0, 4, 1),
(8.00, 'Transporte público', '2026-04-08 08:05:00', 0, 5, 1),
(25.00, 'Cena restaurante', '2026-04-11 20:10:00', 0, 4, 1),
(60.00, 'Gasolina', '2026-04-14 16:40:00', 0, 5, 1),
(9.99, 'Suscripción streaming', '2026-04-18 07:00:00', 0, 8, 1),
(15.00, 'Entrada cine', '2026-04-22 21:00:00', 0, 2, 1),
(50.00, 'Compra online', '2026-05-03 14:20:00', 0, 11, 1),
(20.00, 'Taxi', '2026-05-06 22:10:00', 0, 5, 1),
(30.00, 'Farmacia', '2026-05-09 10:00:00', 0, 6, 1),
(75.00, 'Mantenimiento vivienda', '2026-05-12 09:00:00', 0, 1, 1),
(18.00, 'Almuerzo trabajo', '2026-05-16 13:15:00', 0, 4, 1),
(7.50, 'Café', '2026-05-20 09:30:00', 0, 4, 1),
(120.00, 'Compra electrónica', '2026-05-25 18:45:00', 0, 11, 1),
(35.00, 'Cena amigos', '2026-06-01 20:00:00', 0, 4, 1),
(14.00, 'App móvil (suscripción)', '2026-06-04 07:30:00', 0, 8, 1),
(22.00, 'Transporte - autobús', '2026-06-08 08:20:00', 0, 5, 1),
(55.00, 'Ropa', '2026-06-12 15:00:00', 0, 11, 1),
(28.00, 'Regalo', '2026-06-16 12:00:00', 0, 10, 1),
(11.20, 'Snack', '2026-06-20 16:30:00', 0, 4, 1),

-- Usuario 2 (Irene) - 20 gastos
(60.00, 'Compra supermercado', '2026-04-03 10:00:00', 0, 4, 2),
(14.00, 'Desayuno', '2026-04-06 08:30:00', 0, 4, 2),
(9.50, 'Transporte público', '2026-04-09 08:15:00', 0, 5, 2),
(28.00, 'Cena', '2026-04-12 20:30:00', 0, 4, 2),
(45.00, 'Gasolina', '2026-04-15 17:00:00', 0, 5, 2),
(6.99, 'Suscripción mensual', '2026-04-19 07:00:00', 0, 8, 2),
(20.00, 'Cine', '2026-04-23 21:30:00', 0, 2, 2),
...
(52.00, 'Supermercado', '2026-04-04 10:30:00', 0, 4, 3),
(11.00, 'Desayuno', '2026-04-07 08:45:00', 0, 4, 3),
(7.00, 'Metro', '2026-04-10 08:00:00', 0, 5, 3),
(40.00, 'Restaurante', '2026-04-13 21:00:00', 0, 4, 3),
(55.00, 'Gasolina', '2026-04-16 17:30:00', 0, 5, 3),
(12.99, 'App suscripción', '2026-04-20 07:15:00', 0, 8, 3),
(18.00, 'Cine', '2026-04-24 20:00:00', 0, 2, 3),
...
(70.00, 'Compra supermercado', '2026-04-01 11:00:00', 0, 4, 4),
(13.50, 'Desayuno', '2026-04-05 08:20:00', 0, 4, 4),
(6.00, 'Transporte público', '2026-04-09 07:50:00', 0, 5, 4),
(45.00, 'Cena', '2026-04-13 21:30:00', 0, 4, 4),
(48.00, 'Gasolina', '2026-04-17 18:10:00', 0, 5, 4),
(11.99, 'Suscripción', '2026-04-21 07:30:00', 0, 8, 4),
(16.00, 'Cine', '2026-04-25 20:10:00', 0, 2, 4),
...
(48.00, 'Supermercado', '2026-04-02 12:00:00', 0, 4, 5),
(10.00, 'Desayuno', '2026-04-06 08:00:00', 0, 4, 5),
(5.80, 'Metro', '2026-04-10 08:10:00', 0, 5, 5),
(29.00, 'Cena', '2026-04-13 20:20:00', 0, 4, 5),
(52.00, 'Gasolina', '2026-04-16 17:45:00', 0, 5, 5),
(7.99, 'App suscripción', '2026-04-20 07:05:00', 0, 8, 5),
(13.00, 'Cine', '2026-04-24 21:10:00', 0, 2, 5),
