...
public interface ITipoRecomendacionService {
     ...
     */
    TipoRecomendacionResponseDTO obtenerTipoRecomendacionPorId(Integer id, String nickUsuario, String nickContrasena) throws Exception;
     ...
     */
    List<TipoRecomendacionResponseDTO> listarTodos(String nickUsuario, String nickContrasena) throws Exception;
     ...
     */
    void eliminarTipoRecomendacion(Integer id, String nickUsuario, String nickContrasena) throws Exception;
}